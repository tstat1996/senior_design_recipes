...
//    const url = `http://ec2-54-161-141-174.compute-1.amazonaws.com:8080/request/?courses=${courses}&courseHistory=${courseHistory}&interests=${interests}&diff=${difficulty}&courseQual=${courseQuality}&profQual=${profQuality}`;
